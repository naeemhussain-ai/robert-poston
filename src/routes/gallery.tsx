              ...
              <Reveal delay={index * 0.05} className="h-full"> 
                ...
                > 
                  <img 
                    ...
                    alt={image.alt} 
                    loading="lazy" 
                    className="h-[24rem] w-full object-cover object-top transition-transform duration-[1400ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-105 sm:h-[26rem] lg:h-[28rem]" 
                  /> 
